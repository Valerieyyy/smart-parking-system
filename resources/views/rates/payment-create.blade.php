...
<div class="row">
   ...
   <div class="col-md-12 col-sm-12 col-xs-12">
     ...
     <form action="{{route('payment.paymentStore')}}" method="post" >
        @csrf
        ...
        <div class="form-group">
          ...
          <div class="col-md-6 col-sm-6 col-xs-12">
             <input id="rate_name" class="form-control col-md-12 col-xs-12" name="rate_name" placeholder="Enter Firstname" required type="text" >
        ...
        <div class="form-group">
          ...
          <div class="col-md-6 col-sm-6 col-xs-12">
             <input id="rate" class="form-control col-md-12 col-xs-12" name="rate" placeholder="Enter Firstname" required type="text" >
