...
<div class="row">
   ...
   <div class="col-md-12 col-sm-12 col-xs-12">
     ...
     <form action="{{route('category.categoriesStore')}}" method="post" >
        @csrf
        ...
        <div class="form-group">
          ...
          <div class="col-md-6 col-sm-6 col-xs-12">
             <input id="name" class="form-control col-md-12 col-xs-12" name="name" placeholder="Enter category name" required type="text" >
