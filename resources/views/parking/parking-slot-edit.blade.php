...
<div class="row">
   ...
   <div class="col-md-12 col-sm-12 col-xs-12">
     ...
     <form action="{{route('parking.update',[$id])}}" method="post" >
        @csrf
        ...
        <div class="form-group">
          ...
          <div class="col-md-6 col-sm-6 col-xs-12">
             <input id="slot" class="form-control col-md-12 col-xs-12" name="slot" placeholder="Enter Firstname" required type="text" value='{{$slot}}' >
